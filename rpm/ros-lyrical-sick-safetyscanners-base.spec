...
%global pkg_name sick_safetyscanners_base
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-sick-safetyscanners-base
Version:        1.0.3
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Lennart Puck <puck@fzi.de> - 1.0.3-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Lennart Puck <puck@fzi.de> - 1.0.3-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Lennart Puck <puck@fzi.de> - 1.0.3-1
- Autogenerated by Bloom
